...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/aHG3ET6G81)
...
```sh
npx nx serve the-black-pearl
```

To create a production bundle:

```sh
npx nx build the-black-pearl
```

To see all available targets to run for a project, run:

```sh
npx nx show project the-black-pearl
```
